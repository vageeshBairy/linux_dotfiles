...
// Brightness Commands
static const char *brightness_inc[] = {"light", "-A", "2", NULL};
static const char *brightness_dec[] = {"light", "-U", "2", NULL};
...
// Multimedia Commands
static const char *play_audio[]			= { "mpc", "toggle",	NULL }; 
static const char *pause_audio[]		= { "mpc", "toggle",	NULL };
static const char *next_audio[] 		= { "mpc", "next",		NULL };
static const char *previous_audio[] 	= { "mpc", "prev",		NULL };
...
static const Key keys[] = {
	...
	{ 0,       						XK_F9,						spawn,    	   		{.v = brightness_inc 	} },
  	{ 0,       						XK_F8, 	   					spawn,		   		{.v = brightness_dec 	} },
	{ 0,                       		XF86XK_AudioLowerVolume,	spawn, 				{.v = downvol 			} },
	{ 0,                       		XF86XK_AudioMute,			spawn,   			{.v = mutevol 			} },
	{ 0,                       		XF86XK_AudioRaiseVolume, 	spawn, 				{.v = upvol   			} },
	{ 0,							XF86XK_AudioPlay,			spawn,				{.v = play_audio		} },
	{ 0,							XF86XK_AudioPause,			spawn,				{.v = pause_audio		} },
	{ 0,							XF86XK_AudioNext,			spawn,				{.v = next_audio		} },
	{ 0,							XF86XK_AudioPrev,			spawn,				{.v = previous_audio	} },
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
